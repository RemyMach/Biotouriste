...
class AnnounceController extends Controller
{
    ...
    public function selectHistorySeller(Request $request, Client $client){
        ...
        $query = $client->request('POST', 'http://127.0.0.10::80/api/announce/historySeller', ['form_params' => $data]);
    ...
    public function update(Request $request, Client $client){
        ...
        $query = $client->request('POST', 'http://127.0.0.10::80/api/announce/update', ['form_params' => $data]);
        $response = json_decode($query->getBody()->getContents());
    ...
    public function delete(Request $request, Client $client){
        ...
        $data['api_token'] = $this->sessionUser->api_token;
        $data['idAnnounce'] = 4;
        $query = $client->request('POST', 'http://127.0.0.10::80/api/announce/delete', ['form_params' => $data]);
        $response = json_decode($query->getBody()->getContents());
    ...
    public function store(Request $request, Client $client){
        ...
        $data['idUser'] = $this->sessionUser->idUser;
        $data['api_token'] = $this->sessionUser->api_token;
        $query = $client->request('POST', 'http://127.0.0.10::80/api/announce/store', ['form_params' => $data]);
        $response = json_decode($query->getBody()->getContents());
    ...
    public function filterByCategorie(Request $request, Client $client){
        ...
        $query = $client->request('POST', 'http://127.0.0.10::80/api/filterByCategorie', ['form_params' => $data]);
        $response = json_decode($query->getBody()->getContents());
    ...
    public function filterByCity(Request $request, Client $client){
        ...
        $data['idUser'] = config('api.api_admin_id');
        $data['api_token'] = config('api.api_admin_token');
        $query = $client->request('POST', 'http://127.0.0.10::80/api/filterByCity', ['form_params' => $data]);
        $response = json_decode($query->getBody()->getContents());
