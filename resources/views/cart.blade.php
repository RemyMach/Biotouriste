        ...
        <div class="row" style="margin:0;">
            <div class="col-xs-12 col-sm-12 col-md-10 offset-md-1 text-center">
                    ...
                    <div id="product">
                        @if($announces != null)
                            ...
                            <table class="table">
                                ...
                                @if(isset($announce['announce_name']))
                                <tr>
                                    ...
                                    <td>
                                        <form action="qantmore" method="get">
                                            ...
                                            <button class="+button" value="" onclick="window.location.href='{!!route('qantmore')!!}'">+
                                            </button>
                                        </form>
                                        <form action="qantless" method="get">
                                            <input type="hidden" value="{{ $key }}" name="index">
                                            <button class="-button" onclick="window.location.href='{!!route('qantless')!!}'">-
                                            </button>
                                        </form>
                ...
                <div class="cta" data-aos="fade-up">
                    <div class="row">
                        <div class="col-md-12">
                            <button type="button" name="button" onclick="window.location.href='{{ url('announces') }}'">
                                Continue shopping
                            </button>
                            <button type="submit" name="button" onclick="window.location.href='{!!route('ccart')!!}'"
                                    formmethod="post">Proceed to payment
                            </button>
                            @else
