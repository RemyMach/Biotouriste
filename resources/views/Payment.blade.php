...
<div class="form-container">
    ...
    <div class="field-container">
        ...
        <input id="cardnumber" type="text" inputmode="numeric" name="card_no" required>
    ...
    <div class="field-container">
        ...
        <input id="expirationdate" type="text" inputmode="numeric" name="ccExpiry" required>
    </div>
    <div class="field-container">
        <label for="securitycode">Security Code</label>
        <input id="securitycode" type="text"  inputmode="numeric" name="cvvNumber" required>
    </div>
</div>
